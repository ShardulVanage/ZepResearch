          ...
          <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
            <figure className="relative isolate pt-6 sm:pt-12">
              ...
              <blockquote className="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
                <p>
                  Our promise is to propel academic superiority through
                  groundbreaking colloquies, world-class journals, and strategic
                  professional enhancement opportunities.
                </p>
              </blockquote>
              <figcaption className="mt-8 text-base">
                <div className="font-semibold text-white">Priyanka</div>
                <div className="mt-1 text-gray-400">CEO of Zep Research</div>
              </figcaption>
            </figure>
          </div>
        </div>
