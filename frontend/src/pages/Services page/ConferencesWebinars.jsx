...
function ConferencesWebinars() {
  return (
    <section>
       <Helmet>
                                                               {/* Basic meta tags */}
                                                               <title>ConferencesWebinars | Zepresearch | International Journal Publication and Conference</title>
                                                               <meta 
                                                                 name="description" 
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="grid md:grid-cols-2 gap-12">
          <div className="lg:w-3/4">
            ...
            <img 
              src="https://res.cloudinary.com/dwlhesiyi/image/upload/v1726495440/lvogggwj5bofrbstts0g.png" 
              alt="" 
              className="sm:pl-16 p-12 sm:p-0"
            />
          </div>
