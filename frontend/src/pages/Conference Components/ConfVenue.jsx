...
import { Carousel, Card } from "../../Aceternity Component/apple-cards-carousel";
  ...
  return (
    <div className="w-full h-full py-20">
      <h2 className="max-w-7xl pl-4 mx-auto text-xl md:text-5xl font-bold text-neutral-800 font-sans">
        International  Conference <span className="bg-clip-text text-transparent bg-gradient-to-tr from-cyan-500 via-blue-500 to-blue-600"> 2024</span> 
      </h2>
        ...
        return (
          ...
          <div
            ...
            <Image
              ...
              height="500"
              width="500"
              className="md:w-1/2 md:h-1/2 h-full w-full mx-auto object-fill"
            />
